@section('titulo', 'Actualizar agendamento de gravação')
<div>
    <div>
                    ...
                    <div class="row gy-4 d-table d-md-flex">
                        ...
                        <div class="col">
                            ...
                            <div class="card card-animated p-4">
                                ...
                                <select class="form-control" name="" id="cliente_id" wire:model="cliente_id">
                            ...
                            <div class="col-12 card card-animated p-4 d-table d-md-flex">
                                ...
                                <div class="col table-responsive">
                                    ...
                                    <p>
                                        ...
                                        @foreach ($participantesEscolhidos as $chave => $item)
                                            @php
                                                $particEscolhidos .= $this->buscarNomeParticipante($item);
                                            @endphp
                                        @endforeach
                        ...
                        <div class="col-12">
                            ...
                            <div class="card card-animated">
                                <div class="col d-table d-md-flex justify-content-between">
                                    <div class="col m-3">
                                        <div class="row">
                                            <label class="text-primary fw-bold" for="">Actualizar Agendamento</label> <br>
                                        </div>
                                    </div>
                                </div>
