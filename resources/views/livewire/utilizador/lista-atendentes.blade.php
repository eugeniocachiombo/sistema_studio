@section('titulo', 'Todos Atendentes')
<div>
    <main id="main" class="main">
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Listagem de atendentes</li>
                </ol>
            </nav>
        </div>
        ...
        <section class="section contact">
            <div class="card card-animated p-4">
                <div class="col ">
                    <label class="text-primary fw-bold" for="">Lista de atendentes</label> <br>
